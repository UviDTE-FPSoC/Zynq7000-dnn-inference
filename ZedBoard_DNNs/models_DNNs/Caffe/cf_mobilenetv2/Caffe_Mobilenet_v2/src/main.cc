...
void preprocessing(Mat &image, int &inputTensor_width, int &inputTensor_height) {
    ...
    /* Centre crop to the actual size of the input tensor, 224x224 for Mobilenetv2 */

...
/* Input Node for Kernel Inceptionv3 */
#define INPUT_NODE      "conv1_3x3_s2"
/* Output Node for Kernel Inceptionv3 */
#define OUTPUT_NODE     "classifier"
/* File where the execution time results are going to be writed to */
#define OUTPUT_FILENAME "cf_Inceptionv3_ImageInput.txt"

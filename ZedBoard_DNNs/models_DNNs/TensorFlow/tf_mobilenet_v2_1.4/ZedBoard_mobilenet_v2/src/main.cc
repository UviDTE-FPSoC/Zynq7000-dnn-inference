...
#define KERNEL_DNN "mobilenet_v2_0"
/* Input Node for Kernel Mobilenetv2 */
#define INPUT_NODE      "MobilenetV2_Conv_Conv2D"
/* Output Node for Kernel Mobilenetv2 */
#define OUTPUT_NODE     "MobilenetV2_Logits_Conv2d_1c_1x1_Conv2D"
/* File where the execution time results are going to be writed to */
#define OUTPUT_FILENAME "tf_Mobilenetv2_ImagesInput.txt"
...
/**
 * @brief perform image pre-processing for TensorFlow Mobilenetv2
 *
 * @param image - reference to the mat object containing an image in RGB format
...
void preprocessing(Mat &image, int &inputTensor_width, int &inputTensor_height) {
    ...
    /* Resize to the actual size of the input tensor, 224x224 for Mobilenetv2 */

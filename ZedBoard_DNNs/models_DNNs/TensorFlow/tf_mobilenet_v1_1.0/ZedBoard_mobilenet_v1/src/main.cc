...
#define OUTPUT_FILENAME "tf_Mobilenetv1_ImagesInput.txt"
...
/**
 * @brief perform image pre-processing for TensorFlow Mobilenetv1
 *
 * @param image - reference to the mat object containing an image in RGB format
...
void preprocessing(Mat &image, int &inputTensor_width, int &inputTensor_height) {
    ...
    /* Resize to the actual size of the input tensor, 224x224 for Mobilenetv1 */

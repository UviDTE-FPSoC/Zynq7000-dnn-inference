...
#define KERNEL_DNN "inception_v3_0"
/* Input Node for Kernel Inception_v3 */
#define INPUT_NODE      "InceptionV3_InceptionV3_Conv2d_1a_3x3_Conv2D"
/* Output Node for Kernel Inception_v3 */
#define OUTPUT_NODE     "InceptionV3_Logits_Conv2d_1c_1x1_Conv2D"
/* File where the execution time results are going to be writed to */
#define OUTPUT_FILENAME "tf_Inceptionv3_RandomInput.txt"
...
void runDNN(DPUTask *taskDNN) {
    ...
    for (int i = 0; i<500; i = i + 1) {	// Expresion to go through out all the iterations of the images vector.
        ...
        /* Create random input. Inceptionv3 model only executes with pixels with 0 value. */
